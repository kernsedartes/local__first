"""
Django settings for local_first project.
...
SECRET_KEY = 'django-insecure-x-shg2p9oqdan%4@zdk=p)@%-z+s9f#8lp24rme-)d_de@)xfs'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False  # Для разработки

ALLOWED_HOSTS = ['*', '127.0.0.1', 'localhost', '56218ef983f3-8301993767665431593.ngrok-free.app']
